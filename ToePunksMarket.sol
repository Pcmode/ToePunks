...
contract ToePunksMarket {

    // You can use this hash to verify the image file containing all the punks
    string public imageHash = "https://toepunks.cryptazoo.com/verify.png";

    address owner;

    string public standard = 'ToePunks';
    string public name;
    ...
    function CryptoPunksMarket() payable {
        ...
        owner = msg.sender;
        totalSupply = 29347;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        name = "TOEPUNKS";                                   // Set the name for display purposes
        symbol = "𝖕";                               // Set the symbol for display purposes
